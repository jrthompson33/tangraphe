...
(function() {
    ...
    var unpinCA = new ContextAction('UNPIN', 'nodeunpin', ["M6.2,42.4c-3.7-3.9-5.6-8-4.3-9.3L3,32c1-1,3.7-0.1,6.7,2.1l6.8-6.8c-1.7-2.3-2.5-4.1-1.9-4.8l1.4-1.4 " +"c0.9-0.9,4.5,1.2,8,4.7c3.5,3.5,5.6,7.1,4.7,8l-1.4,1.4c-0.6,0.6-2.5-0.2-4.8-1.9l-6.8,6.8c2.2,3,3.2,5.7,2.1,6.7l-1.1,1.1 "+"c-1.3,1.3-5.4-0.6-9.3-4.2l-3.9,3.9L-2.5,53L-3,52.5l5.2-6.2L6.2,42.4z"]);

    var linkCMList = [linkremoveCA, bundleCA, nodeCA];
    var nodeCMList = [noderemoveCA, expandCA, collapseCA, linkCA, unpinCA];
